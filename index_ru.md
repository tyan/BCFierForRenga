...
- добавлять замечания к объектам модели, стилей сборки и чертежей;
- добавлять скриншоты видов с графическими аннотациями;
- cохранять точки взгляда на 3D-вид и стиль сборки с состоянием видимости и выбора объектов;
