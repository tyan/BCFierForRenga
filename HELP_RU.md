...
Создавайте с его помощью замечания к текущему состоянию 3D-вида, стиля сборки или чертежа в Renga.

Чтобы создать замечание к объектам стиля сборки или чертежей:

1. Выделите объект в нужной вкладке.
2. Создайте новый вид.

[!NOTE]
Если при создании вида стиля сборки или чертежа ни один объект не выбран, то при переходе к виду в замечании вкладка компонента проекта открыта не будет.
